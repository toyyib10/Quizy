...
const Signup = () => {
  ...
  const endPoint = "https://quizy-api.onrender.com/auth/login";
  ...
  return (
    ...
    >
      <div className="slide-controls d-flex border-bottom rounded-top-2">
        ...
        <label for="login" className="slide login w-50">
          {" "}
          Login{" "}
        </label>
        <label
          for="signup"
          className="slide signup w-50"
