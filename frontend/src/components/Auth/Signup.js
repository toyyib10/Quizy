...
const Signup = () => {
  ...
  const endPoint = "https://quizy-api.onrender.com/auth/createaccount";
  ...
  return (
    <div
      className="col-lg-7 col-md-9  col-11 bg-white shadow rounded-2"
      style={{ minHeight: "80vh" }}
    >
      <div className="slide-controls d-flex border-bottom rounded-top-2">
        <input type="radio" name="slide" id="login" />
        <input type="radio" name="slide" id="signup" checked />
        <label for="login" className="slide login w-50" onClick={() => logIn()}>
          {" "}
          Login{" "}
        </label>
        <label for="signup" className="slide signup w-50">
          Create Account
        </label>
        <div
      ...
      <div className="w-100 pt-2 hold">
        ...
        >
          ...
          <div className="w-100 d-flex justify-content-center pt-lg-3 pt-4">
            <button
              type="submit"
              className="btn btn-lg btn-light text-white w-75 hover"
            >
              Create Account
            </button>
          </div>
