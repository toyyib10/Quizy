...
const Success = () => {
  ...
  return (
    <>
      <section className='w-100 d-flex align-content-center justify-content-center flex-column px-2 pb-3' style={{ "height": "100vh" }}>
      ...
      <Modal show={ modal }>
        ...
        <ModalBody>
          <div className='d-flex justify-content-between'>
            <input className='col-10 me-2' type="button" data-bs-toggle="tooltip" data-bs-placement="right" title="Quiz link" value="https://quizy-chi.vercel.app/joinquiz" disabled/>
        ...
        <ModalFooter>
          <button type="button" onClick={ close } className="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        </ModalFooter>
      </Modal>
    </>
  )
