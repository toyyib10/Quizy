...
const Game = () => {
  ...
  const endPoint = "https://quizy-api.onrender.com/quiz/addQuestion";
  const deletePoint = "https://quizy-api.onrender.com/quiz/deleteQuestion";
  const savePoint = "https://quizy-api.onrender.com/quiz/saveQuiz";
  const checkPoint = "https://quizy-api.onrender.com/auth/dashboard";
  ...
  return (
    <>
      <header className="navbar sticky-top bg-white navbar-white px-md-0 px-lg-0 px-4 shadow d-flex ">
        <h2
          className="navbar-bran m-0 p-0 col-md-3 col-lg-2 ps-md-4 ps-lg-4"
      ...
      <div className="col-12 px-4 pt-4">
        ...
        <form action="">
          <div className="w-100 mt-4 d-flex justify-content-between px-1 px-md-4 px-lg-4">
            <div className="w-50 me-2 me-md-3 p-md-3 p-lg-3 p-2 mt-3 text-white rounded-2 bg-danger shadow d-flex">
              ...
              <input
                className="form-control form-control-lg ms-2 ms-lg-4 ms-md-4"
          ...
          <div className="w-100 mt-4 d-flex justify-content-between px-2 px-md-4 px-lg-4">
            <div className="w-50 me-2 me-md-3 p-md-3 p-lg-3 p-2 mt-3 text-white rounded-2 bg-warning shadow d-flex">
              <p className="m-0 fs-1 text-center p-lg-0 pt- p-md-0 ">C. </p>
              <input
                placeholder="Optional"
                className="form-control form-control-lg ms-2 ms-md-4 ms-lg-4"
            ...
            <div className="w-50 ms-2 ms-md-3 p-md-3 p-lg-3 p-2 mt-3 text-white rounded-2 bg-info shadow d-flex">
              ...
              <input
                ...
                name="forthanswer"
                className="form-control form-control-lg ms-2 ms-md-4 ms-lg-4"
                onChange={(e) => setforthanswer(e.target.value)}
                type="text"
              />
              <input
                className="h-75 ms-1"
        ...
        <div className="col-12 shadow px-3 bg-white mt-4 d-flex justify-content-between align-items-center flex-wrap rounded-2">
          <div
            className="col-md-6 my-1 col-12 bg-light p-1 d-flex"
            style={{ height: "55px", overflowY: "auto" }}
          >
            {allQuestion.map((item, index) => (
              <button
                onClick={() => goTo(index)}
                className="btn btn-primary rounded-1 h-100 text-white mx-1"
                style={{ width: "50px" }}
              >
                {index + 1}
              </button>
          ...
          <div className="d-flex justify-content-end col-md-6 col-12 my-2">
            <div>
              <button
                onClick={addQuestion}
                className="btn btn-success h-100 mx-3"
              >
                {" "}
                Add
              </button>
            ...
            <div>
              <button
                type="button"
                onClick={preSave}
                className="btn btn-primary mx-3 h-100"
                data-bs-toggle="modal"
                data-bs-target="#saveQuestion"
              >
                {" "}
                Save
              </button>
      ...
      <div
        ...
        tabindex="-1"
        aria-labelledby="saveQuestionLabel"
        aria-hidden="true"
      >
